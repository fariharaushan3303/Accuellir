<?php
	...
	session_start();
	include 'db.php';
	$_SESSION["adminuser"]="valid"; //header only be requested from script
	require "header.php";
...
<html>
	...
	<body>
		...
		<form method="post" action="#">
			<table bgcolor="#fffff0" style=" width: 75%; margin:0 auto;">	
				<tr >
			...
			<tr>
				...
				<td  >
					...
					<input type="text" name="year"  style="width:30px"/><i>(dd/mm/yyyy)</i>
				</td>
			</tr>
			-->
			<tr>
				<td colspan="3" style="text-align:center">
					<input id="submit" type="submit" name ="submit" value = "REGISTER " style="font-size: 20px;padding: 5px 40px"/>
				</td>
			</tr>
